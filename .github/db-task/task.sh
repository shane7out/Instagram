#!/bin/bash
# Yelp migration batch: IMG_8046 (5 restaurants/bars).
set -e
...
add_rest "Frankensons" "frankenson"
add_rest "The Oak Room - Grill, Gaming and Cocktails" "oak ?room"
add_rest "Wineaux" "wineaux"
add_rest "ITs SUSHI Southwest" "its ?sushi|it.?s ?sushi"
add_rest "CrunCheese" "cruncheese|crun ?cheese"
